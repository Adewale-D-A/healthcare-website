...
export default function NavMenu() {
  ...
  return (
    <>
      <nav className="w-full flex flex-col items-center justify-center bg-primary-500 text-white sticky top-0 left-0 z-50">
        ...
        <div className="w-full hidden md:flex justify-between items-center gap-4 max-w-screen-xl px-5 md:px-10 py-5">
          ...
          <div className=" flex items-center gap-2">
            <LinkButton href="https://www.anonymizecare.com/" target="_blank">
              AnonymizeCare
            </LinkButton>
            <RequestADemoButton />
          </div>
